...
for alpha in alphas:
    ...
    if (alpha == 'Godunov-N'):
        methods={(0,): "FE", (1,): RadauIIA(1)}
    elif alpha == 'Strang-N' or alpha == 'OSNNS2P2-N':
        methods={(0,): "Heun", (1,): RadauIIA(2)}
    elif alpha == 'PP3_4A-3' or alpha == 'OSNNS4P3-N':
        methods={(0,): "RK3", (1,): RadauIIA(2)}
    else:
        methods = {(0,): "RK4", (1,): RadauIIA(3)}
    for N_step in [200, 400,
        ...
        result = fs.fractional_step([F1_irk, F2, F3], Constant(dt), u, Constant(0), 0.1, alpha, methods, fname=f"3split_{alpha}_{N_step}.h5", save_steps=1)
